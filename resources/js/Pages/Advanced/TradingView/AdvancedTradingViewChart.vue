...
const configureWidget = () => {
    return new window.TradingView.widget({
        ...
        overrides: {
            "paneProperties.backgroundType": "#000",
            ...
            "scalesProperties.backgroundColor": "#000", // gray-800
            "scalesProperties.lineColor": "#000", // gray-750
            "scalesProperties.textColor": "#fff", // gray-450
...
<template>
    <div class="relative">
        <div id="tv_chart_container" class="w-full h-[300px] rounded-lg overflow-hidden"></div>
    </div>
</template>
